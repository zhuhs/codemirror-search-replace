(function (mod) {
    ...
    CodeMirror.defineOption("searchbox", false, function (cm) {
      cm.addKeyMap({
        "Ctrl-F": function () {
          ...
          var isReplace =
            document.querySelector("[action=toggleReplace]").innerText === "-";
    ...
    function SearchBox(cm) {
      ...
      function find(value, options, callback) {
        ...
        if (regExp || wholeWord) {
          if (options.wholeWord) val = "\\b" + val + "\\b";
      ...
      this.toggleReplace = function () {
        if (document.querySelector("[action=toggleReplace]").innerText === "+") {
          document.querySelector("[action=toggleReplace]").innerText = "-";
      ...
      function updateCount() {
        setTimeout(function () {
          var count = document.querySelectorAll(".cm-searching").length;
          var countEle = document.querySelector(".ace_search_counter");
